...
function verCompu(){
    vtexjs.checkout.getOrderForm().then(function (orderForm) {
        ...
        if (marketingData == null) {
            ...
            if (cond == "compumas") {
                $("#payment-group-cardPromissoryPaymentGroup").css("display", "block");
                $("#payment-group-creditCardPaymentGroup").css("display", "none");
                $("#payment-group-custom204PaymentGroupPaymentGroup").css("display", "none");
                $("#payment-group-custom201PaymentGroupPaymentGroup").css("display", "none");
                $(".summary-template-holder").css("display", "none")
                $(".price.pull-right").css("display", "none");
...
function compuMarket() {
    ...
    const compuCuotas = document.querySelector(".box-payment-group2.box-payment-option.cardPromissoryPaymentGroup");
    ...
    const compuCuotasInfo = document.querySelector(".box-payment-group2.box-payment-option.cardPromissoryPaymentGroup");
